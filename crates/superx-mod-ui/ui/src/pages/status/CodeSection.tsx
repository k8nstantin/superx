    ...
    <>
      ...
      <Grid mb="md" gap="md">
        <Grid.Col span={{ base: 12, lg: 8 }}>
          <Panel title="Code churn — added against replaced" scope="range" range={range} note={`${long ? 'per day' : 'per hour'} · your time · solid: the transcript's edits · faint: what landed on main`} h="100%">
            {buckets.length === 0 && (
