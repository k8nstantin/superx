...
| **G10** | **Website module** (2026-08-19, epic #213): `superx-mod-website` — the public site (swindex design system) as a data-less module: static `site/` in git, GitHub Pages CI deploy, local preview served by the OS on `attr_website_port` (second server module coexisting with the ui, D18) | Site live at k8nstantin.github.io/superx; preview + Pages QA'd |
